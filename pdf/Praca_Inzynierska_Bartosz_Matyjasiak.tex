...
a klucz map Google, należało umieścić w~pliku \code{AndroidManifest.xml} przy pomocy odwołania do zmiennych środowiskowych po uprzedniej konfiguracji modułu \code{react-native-config}.
